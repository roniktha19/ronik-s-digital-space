...
const Mom = () => {
  return (
    <div className="min-h-screen pb-12 bg-gradient-to-br from-pink-300 via-pink-200/50 to-pink-100">
      <HamburgerMenu />
        ...
        <div className="max-w-lg mx-auto">
          ...
          <div className="mt-8 flex flex-col items-center animate-fade-in">
            <div className="relative">
              ...
              <div className="absolute inset-0 rounded-full bg-pink-400/30 blur-2xl -z-10 animate-pulse" />
            </div>
            <h1 className="mt-6 text-3xl font-bold text-pink-900">
              My Mom <span className="text-pink-600">Ritu</span>
            </h1>
          </div>

          <div className="mt-8 space-y-6">
            {/* About */}
            <div className="p-6 rounded-xl bg-white/60 border border-pink-300 backdrop-blur-sm animate-fade-in hover:border-pink-400 hover:bg-white/80 transition-all duration-300 hover:scale-[1.02] shadow-lg" style={{ animationDelay: '0.1s' }}>
            ...
            {/* Why I Love Her */}
            <div className="p-6 rounded-xl bg-white/60 border border-pink-300 backdrop-blur-sm animate-fade-in hover:border-pink-400 hover:bg-white/80 transition-all duration-300 hover:scale-[1.02] shadow-lg" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="p-6 rounded-xl bg-white/60 border border-pink-300 backdrop-blur-sm animate-fade-in hover:border-pink-400 hover:bg-white/80 transition-all duration-300 hover:scale-[1.02] shadow-lg" style={{ animationDelay: '0.3s' }}>
            ...
            {/* My Message */}
            <div className="p-6 rounded-xl bg-white/60 border border-pink-300 backdrop-blur-sm animate-fade-in hover:border-pink-400 hover:bg-white/80 transition-all duration-300 hover:scale-[1.02] shadow-lg" style={{ animationDelay: '0.4s' }}>
              <h2 className="text-xl font-semibold text-pink-600 mb-4">A Message to Mom</h2>
